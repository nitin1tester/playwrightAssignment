...
- Name: gui/swaglabs/loginpage.spec.ts >> Negative: Login failure with invalid credentials
- Location: tests/gui/swaglabs/loginpage.spec.ts:31:1
...
Call log:
  - waiting for getByRole('heading', { name: 'Epic sadface: Username and password do not match any user in this service', level: 3 }).first()
...
- generic [ref=e3]:
  ...
  - main [ref=e5]:
    - form "Login" [ref=e9]:
      - generic [ref=e10]:
        - textbox "Username" [ref=e11]: wrongData
        - img [ref=e12]
      - generic [ref=e14]:
