...
- Name: gui/swaglabs/checkoutpage.spec.ts >> Positive: Complete checkout flow Priya 
...
Call log:
  - waiting for getByRole('textbox', { name: 'Last Name' }).first()
    - locator resolved to <input value="" type="text" id="last-name" name="lastName" autocorrect="off" data-test="lastName" autocapitalize="none" aria-label="Last Name" placeholder="Last Name" class="input_error form_input"/>
    - fill("Verma")
